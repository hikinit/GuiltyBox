...
class AGAudioRecorder: NSObject {
    ...
    private var audioPitch: AVAudioUnitTimePitch! = nil
    private var audioSpeed: AVAudioUnitVarispeed! = nil
...
//                try session.setActive(true)
    ...
    func playEngine(pitch: Float = 0){
        do {
            ...
            audioSpeed = AVAudioUnitVarispeed()
            ...
            audioEngine.connect(audioPlayer, to: audioSpeed, format: nil)
